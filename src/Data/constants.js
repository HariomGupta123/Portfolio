...
export const education = [
  ...
  },
  {
    ...
    grade: "78.75%",
    desc: "I completed my class 10 education at Shree yashodhara Ma Vi School, Kapilvastu.",
    degree: "SEE(X)",
  },
];
...
export const projects = [

  {
    ...
    image: `${kagzpatra}`,
    tags: ["React Js", "MongoDb", "Node Js", "Express Js", "Redux tool kit"],
    category: "web app",
...

  {
    ...
    date: "Jul 2024",
    description:
      "A Messanger clone made with Next JS, Mongodb, . It has Phone Authentication, Real-time Database. It has a chat room where users can chat with each other. It has a sidebar where users can see all the chat rooms and can create a new chat room. It has a login page where users can log in with their Google account and github.",
    image: `${messanger}`,
  ...
  },
  {
    ...
    date: "Dec 2022",
    description:
      " A Todo Web App made with React JS, Redux, and Material UI.  users can see all the tasks and can create a new task and can edit the task , can tick the task as completed.",
    image: `${todo}`,
    tags: ["React Js", "Local Storage", "Redux", "tailwind"],
    category: "web app",
  ...
  {
    id: 4,
    title: "MovieInfo Web App",
    date: "Jun 2023",
    description:
      " A Todo Web App made with React JS, axios, and css.It has NavBar  users can see all the popular,Imdb rate, upcoming movies . It has a page where users can see movies detials.",
    image: `${movieInfo}`,
  ...
  },
  {
    ...
    date: "Jun 2022",
    description:
      " A e-commerce Web App made with React JS, Redux, and axios, css.  users can shop products and add products and checkout.",
    image: `${ecommerce}`,
    tags: ["React Js", "Redux ", "css", "axios"],
    category: "web app",
    github: "https://github.com/HariomGupta123/AddToCardApp",
    webapp: "add-to-card-app.vercel.app",
  },
];
